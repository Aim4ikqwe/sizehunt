...
// SignalDB представляет сигнал OKX в базе данных
type SignalDB struct {
	ID              int64     `db:"id"`
	UserID          int64     `db:"user_id"`
	InstID          string    `db:"inst_id"`   // OKX instrument ID (например BTC-USDT-SWAP)
	InstType        string    `db:"inst_type"` // SPOT, SWAP, FUTURES, OPTION
