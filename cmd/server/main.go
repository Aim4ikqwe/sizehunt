// cmd/server/main.go
package main // TODO Сделать корректную инициализацию прокси. при отсутсвии у пользователя активных сигналов после удаления 1 из сигналов, то стопать докер с прокси
// TODO При создании сигнала проверять на наличие в докере контейнера с прокси и при отсутсвии создавать его, а если есть то запускать его
